  ...
  useEffect(() => {
    if (svgRef.current) {
      ...
      if (path) {
        ...
        // const position = path.getPointAtLength(length / 24 * 1); // 開始時刻
        // const position = path.getPointAtLength((length / 24) * 23); // 終了時刻
        const position = path.getPointAtLength((length / 24) * 12); // 南中
        // const position = path.getPointAtLength((length / 24) * 5); // 日の出
        // const position = path.getPointAtLength(length / 24 * 19); // 日の入り
        ...
        icon.setAttributeNS(null, "y", (position.y - 13).toString());
      ...
      <g style={{ clipPath: "url(#clippath)" }}>
        ...
        <g style={{ opacity: ".9" }}>
          ...
          <path
            ...
            style={{ fill: "none", stroke: "#545454", strokeMiterlimit: 10 }}
          />
          <path
        ...
        <text fontSize="12" x="45" y="33" fill="#545454">
        ...
        <text fontSize="12" x="300" y="33" fill="#545454">
